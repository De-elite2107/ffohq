// icon:line-chart | Ant Design Icons https://ant.design/components/icon/ | Ant Design
import * as React from "react";

function IconUpChart(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
